...
#include "MotionSynthesis.generated.h"

// This class has all the important settings for the motion matching system
UCLASS()
class MOTIONSYNTHESIS_API UMotionSchema : public UDataAsset
{
	GENERATED_BODY()
...
UCLASS()
class MOTIONSYNTHESIS_API UMotionDatabase : public UDataAsset
{
	GENERATED_BODY()
public:
...
struct MOTIONSYNTHESIS_API FMotionTrajectory
{
	GENERATED_BODY()
...
class FMotionSynthesisModule : public IModuleInterface
{
public:
